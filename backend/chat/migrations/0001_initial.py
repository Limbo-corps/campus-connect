...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='participants',
            field=models.ManyToManyField(blank=True, related_name='conversations', through='chat.ConversationParticipant', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Message',
            fields=[
                ...
                ('attachment', models.FileField(blank=True, null=True, upload_to='chat/messages/')),
        ...
        migrations.AddIndex(
            model_name='conversationparticipant',
            index=models.Index(fields=['conversation'], name='chat_conver_convers_742c68_idx'),
        ),
